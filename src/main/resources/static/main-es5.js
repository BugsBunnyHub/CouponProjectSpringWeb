(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AddCompanyComponent = /** @class */ (function () {
            function AddCompanyComponent(client) {
                this.client = client;
            ...
            AddCompanyComponent.prototype.addCompany = function () {
                this.client.addCompany(this.company).subscribe(function (result) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AddCouponComponent = /** @class */ (function () {
            ...
            AddCouponComponent.prototype.addCoupon = function () {
                this.client.addCoupon(this.coupon).subscribe(function (result) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var DeleteCompanyComponent = /** @class */ (function () {
            ...
            DeleteCompanyComponent.prototype.deleteCompany = function () {
                this.client.deleteCompany(this.company.id).subscribe(function () {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var DeleteCouponPurchaseComponent = /** @class */ (function () {
            function DeleteCouponPurchaseComponent(client) {
                this.client = client;
                this.coupon = new _models_coupons__WEBPACK_IMPORTED_MODULE_2__["Coupons"]();
            }

            DeleteCouponPurchaseComponent.prototype.deleteCouponPurchase = function () {
                this.client.deleteCouponPurchase(this.coupon).subscribe(function () {
                    alert('coupon deleted');
                });
            };
            DeleteCouponPurchaseComponent.prototype.ngOnInit = function () {
            };
            return DeleteCouponPurchaseComponent;
        }());
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var DeleteCouponComponent = /** @class */ (function () {
            function DeleteCouponComponent(client) {
                this.client = client;
                this.coupon = new _models_coupons__WEBPACK_IMPORTED_MODULE_2__["Coupons"]();
            }

            DeleteCouponComponent.prototype.deleteCoupon = function () {
                this.client.deleteCoupon(this.coupon.id).subscribe(function () {
                    alert('coupon deleted');
                });
            };
        ...
        DeleteCouponComponent.ctorParameters = function () {
            return [
                {type: _services_company_service__WEBPACK_IMPORTED_MODULE_3__["CompanyService"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var DeleteCustomerComponent = /** @class */ (function () {
            ...
            DeleteCustomerComponent.prototype.deleteCustomer = function () {
                this.client.deleteCustomer(this.customer.id).subscribe(function () {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var GetAllCompaniesComponent = /** @class */ (function () {
            ...
            GetAllCompaniesComponent.prototype.ngOnInit = function () {
                var _this = this;
                this.client.getAllCompanies().subscribe(function (result) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var GetAllCouponsComponent = /** @class */ (function () {
            function GetAllCouponsComponent(client) {
                this.client = client;
                this.coupons = [];
            }
        ...
        GetAllCouponsComponent.ctorParameters = function () {
            return [
                {type: _services_admin_service__WEBPACK_IMPORTED_MODULE_2__["AdminService"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var GetCompanyDetailsComponent = /** @class */ (function () {
            function GetCompanyDetailsComponent(client) {
                this.client = client;
                this.company = new _models_companies__WEBPACK_IMPORTED_MODULE_2__["Companies"]();
            }
        ...
        GetCompanyDetailsComponent.ctorParameters = function () {
            return [
                {type: _services_company_service__WEBPACK_IMPORTED_MODULE_3__["CompanyService"]}
            ];
        };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var GetCustomerCouponsComponent = /** @class */ (function () {
            function GetCustomerCouponsComponent(client) {
                this.client = client;
                this.coupons = [];
            }
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var GetOneCompanyComponent = /** @class */ (function () {
            ...
            GetOneCompanyComponent.prototype.getOneCompanyById = function () {
                var _this = this;
                this.client.getOneCompanyById(this.company.id).subscribe(function (result) {
            ...
            GetOneCompanyComponent.prototype.getOneCompanyByName = function () {
                var _this = this;
                this.client.getOneCompanyByName(this.company.name).subscribe(function (result) {
                    if (result == null || undefined) {
                        alert('Company not found!');
                    } else {
                        _this.company = result;
            ...
            GetOneCompanyComponent.prototype.getOneCompanyByEmail = function () {
                var _this = this;
                this.client.getOneCompanyByEmail(this.company.email).subscribe(function (result) {
                    if (result == null || undefined) {
                        alert('Company not found!');
                    } else {
                        _this.company = result;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var GetOneCustomerComponent = /** @class */ (function () {
            ...
            GetOneCustomerComponent.prototype.getOneCustomerById = function () {
                var _this = this;
                this.client.getOneCustomerById(this.customer.id).subscribe(function (result) {
                    if (result == null || undefined) {
            ...
            GetOneCustomerComponent.prototype.getOneCustomerByEmail = function () {
                var _this = this;
                this.client.getOneCustomerByEmail(this.customer.email).subscribe(function (result) {
                    if (result == null || undefined) {
                        alert('customer not found!');
                    } else {
                        _this.customer = result;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var NavigationComponent = /** @class */ (function () {
            function NavigationComponent(client) {
                this.client = client;
            }
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var PurchaseCouponComponent = /** @class */ (function () {
            ...
            PurchaseCouponComponent.prototype.purchaseCoupon = function (c) {
                this.client.purchaseCoupon(c).subscribe(function (result) {
                    if (result != null) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var UpdateCompanyComponent = /** @class */ (function () {
            function UpdateCompanyComponent(client) {
                this.client = client;
            ...
            UpdateCompanyComponent.prototype.updateCompany = function () {
                this.client.updateCompany(this.company).subscribe(function (result) {
                    alert('company info:  ' + 'company ID: ' + result.id + ' name: ' + result.name + ' email: ' + result.email);
                });
            };
            // get company name by it's ID to auto fill the "name" field in the update page
            UpdateCompanyComponent.prototype.getCompanyId = function () {
                var _this = this;
                this.client.getCompanyId(this.company.id).subscribe(function (result) {
                    if (result == null || undefined) {
                        _this.company.name = 'company not found!';
                    } else {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var UpdateCustomerComponent = /** @class */ (function () {
            ...
            UpdateCustomerComponent.prototype.getCustomerId = function () {
                var _this = this;
                this.client.getOneCustomerById(this.customer.id).subscribe(function (result) {
                    if (result == null || undefined) {
                        _this.customer.firstName = 'customer not found!';
                        _this.customer.lastName = '';
                        _this.customer.email = '';
                        _this.customer.password = '';
                    } else {
                        _this.customer.firstName = result.firstName;
                        _this.customer.lastName = result.lastName;
                        _this.customer.email = result.email;
                    }
                });
            };
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var Companies = /** @class */ (function () {
            function Companies(id, name, email, password) {
                this.id = id;
                this.name = name;
                this.email = email;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var Coupons = /** @class */ (function () {
            // tslint:disable-next-line:max-line-length
            function Coupons(id, companyID, title, description, image, category, startDate, endDate, price, amount) {
                this.id = id;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var Customers = /** @class */ (function () {
            function Customers(id, firstName, lastName, email, password) {
                this.id = id;
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var AdminService = /** @class */ (function () {
            ...
            AdminService.prototype.getCompanyId = function (id) {
            ...
            AdminService.prototype.getOneCompanyById = function (id) {
                return this.client.get('http://localhost:8080/admin/findCompanyById/' + id + '/' + sessionStorage.token);
            };
            AdminService.prototype.getOneCompanyByName = function (name) {
                return this.client.get('http://localhost:8080/admin/findCompanyByName/' + name + '/' + sessionStorage.token);
            };
            AdminService.prototype.getOneCompanyByEmail = function (email) {
                return this.client.get('http://localhost:8080/admin/findCompanyByEmail/' + email + '/' + sessionStorage.token);
            };
            AdminService.prototype.addCustomer = function (customer) {
            ...
            AdminService.prototype.getOneCustomerById = function (id) {
                return this.client.get('http://localhost:8080/admin/findCustomerById/' + id + '/' + sessionStorage.token);
            };
            AdminService.prototype.getOneCustomerByEmail = function (email) {
    ...
    /***/ (function (module, __webpack_exports__, __webpack_require__) {
        ...
        var CustomerService = /** @class */ (function () {
            ...
            CustomerService.prototype.getCustomerCoupons = function () {
            ...
            CustomerService.prototype.deleteCouponPurchase = function (coupon) {
